    ...
    <div className={classes.root}>
      ...
      <div className={classes.userInfo} onClick={handlePopoverOpen}>
        <div
          ...
          <div className="mr-2">
            <Typography className={classes.userTitle} component="h2" variant="h6">
              {authUser.nombres + ' ' + ('undefined' ? '' : authUser.apellidoPaterno) + ' ' + ('undefined' ? '' : authUser.apellidoMaterno) }
            </Typography>
            {/* <Typography className={classes.userSubTitle}>{authUser.user}</Typography> */}
          </div>
          <ArrowDropDownIcon />
        </div>
      </div>
