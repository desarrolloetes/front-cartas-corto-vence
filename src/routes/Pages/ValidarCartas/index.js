...
import CartaListRow from './ValidarCartaListRow';
import CartaTableHead from './ValidarCartaTableHead';
import CartaTableToolbar from './ValidarCartaTableToolbar';
import { getComparator, stableSort } from '../../../@jumbo/utils/tableHelper';
import { useDispatch, useSelector } from 'react-redux';
import { deleteCarta, getCartasByCategoryManager, setCurrentCarta } from '../../../redux/actions/Cartas';
...
import ValidarCartaDetailView from './ValidarCartaDetailView';
import CartaDetailView from '../Cartas/CartaDetailView';
import NoRecordFound from './NoRecordFound';
import IntlMessages from '@jumbo/utils/IntlMessages';

const ValidarCartasModule = () => {
  ...
  useEffect(() => {
    dispatch(
      getCartasByCategoryManager(authUser.empresaCodigo, authUser.user, filterOptions, debouncedSearchTerm, () => {
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteCarta(selectedCarta.idCarta));
  ...
  return (
    <div className={classes.root}>
      ...
      {openCartaDialog && <CartaDetailView open={openCartaDialog} onCloseDialog={handleCloseCartaDialog} />}
      {openViewDialog && <ValidarCartaDetailView open={openViewDialog} onCloseDialog={handleCloseViewDialog} />}

      <ConfirmDialog
        open={openConfirmDialog}
        title={<IntlMessages id="cartas.appModule.deleteConfirm" />}
        content={<IntlMessages id="cartas.appModule.deleteMessage" />}
...
export default ValidarCartasModule;
