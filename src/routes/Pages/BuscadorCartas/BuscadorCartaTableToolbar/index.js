...
const BuscadorCartaTableToolbar = ({
  selected,
  setSelected,
  onCartaAdd,
  filterOptions,
      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="buscadorCartas.appModule.cartas" />}{' '}
          </Typography>
        )}
...
BuscadorCartaTableToolbar.propTypes = {
...
export default React.memo(BuscadorCartaTableToolbar);
