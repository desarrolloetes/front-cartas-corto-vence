...
function CartaTableHead({ classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort }) {
...
export default React.memo(CartaTableHead);
