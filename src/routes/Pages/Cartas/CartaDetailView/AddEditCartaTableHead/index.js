...
const headCells = [
  ...
  {
    id: 'productoMotivoRechazo',
    numeric: false,
    disablePadding: false,
    label: <IntlMessages id="cartas.appModule.productoMotivoRechazoHeader" />,
  },      
];

function AddEditCartaTableHead({ classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort }) {
...
AddEditCartaTableHead.propTypes = {
...
export default React.memo(AddEditCartaTableHead);
