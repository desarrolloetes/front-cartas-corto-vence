      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="cartas.appModule.cartas" />}{' '}
            <Button color="primary" onClick={() => onCartaAdd(true)}>
              {<IntlMessages id="cartas.appModule.addNewCarta" />}
            </Button>
          </Typography>
        )}
...
export default React.memo(CartaTableToolbar);
