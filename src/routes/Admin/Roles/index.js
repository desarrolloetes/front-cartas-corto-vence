...
import RoleAplicaciones from './RoleAplicaciones';
...
const RolesModule = () => {
  ...
  const [openAplicacionesDialog, setOpenAplicacionesDialog] = useState(false);
  ...
  useEffect(() => {
    dispatch(
      getRoles(empresaCodigo, filterOptions, debouncedSearchTerm, () => {
  ...
  const handleRoleAplicaciones = role => {
    dispatch(setCurrentRole(role));
    setOpenAplicacionesDialog(true);
  };

  const handleCloseAplicacionesDialog = () => {
    setOpenAplicacionesDialog(false);
    dispatch(setCurrentRole(null));
  };
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteRole(selectedRole.rolId));
    dispatch(
  ...
  return (
    <div className={classes.root}>
                ...
                stableSort(roles, getComparator(order, orderBy))
                  ...
                  .map((row, index) => (
                    <RoleListRow
                      ...
                      onRoleAplicaciones={handleRoleAplicaciones}
      ...
      {openAplicacionesDialog && <RoleAplicaciones open={openAplicacionesDialog} onCloseDialog={handleCloseAplicacionesDialog} />}

      <ConfirmDialog
        open={openConfirmDialog}
        title={<IntlMessages id="roles.appModule.deleteConfirm" />}
        content={<IntlMessages id="roles.appModule.deleteMessage" values={{ code: selectedRole.rolId }} />}
