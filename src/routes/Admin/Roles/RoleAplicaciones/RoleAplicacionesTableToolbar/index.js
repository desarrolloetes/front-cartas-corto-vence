...
const RoleAplicacionesTableToolbar = ({
  //selected,
  //setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      <Toolbar>
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="roles.rolAplicaciones.label.aplicaciones" />}{' '}
...
RoleAplicacionesTableToolbar.propTypes = {
...
export default React.memo(RoleAplicacionesTableToolbar);
