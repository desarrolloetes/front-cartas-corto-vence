...
const filterOptionsList = [
  { label: <IntlMessages id="users.appModule.filterActive" />, value: 1 },
  { label: <IntlMessages id="users.appModule.filterInactive" />, value: 0 },
];

const CategoryManagerTableToolbar = ({
  selected,
  setSelected,
  onUserAdd,
  filterOptions,
      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="categoryManagers.appModule.categoryManagers" />}{' '}
          </Typography>
        )}
...
CategoryManagerTableToolbar.propTypes = {
...
export default React.memo(CategoryManagerTableToolbar);
