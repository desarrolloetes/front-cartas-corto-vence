...
const UsersModule = () => {
  ...
  useEffect(() => {
    dispatch(
      getUsers(empresaCodigo, filterOptions, debouncedSearchTerm, () => {
  ...
  const handleCloseUserDialog = () => {
    ...
    dispatch(setCurrentUserApplications([]));
    dispatch(
  ...
  return (
    <div className={classes.root}>
      ...
      <ConfirmDialog
        ...
        content={<IntlMessages id="users.appModule.deleteMessage" values={{ code: selectedUser.id }} />}
