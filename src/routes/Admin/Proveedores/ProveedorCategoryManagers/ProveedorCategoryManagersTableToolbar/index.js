...
const ProveedorCategoryManagersTableToolbar = ({
  //selected,
  //setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      <Toolbar>
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="proveedores.proveedorCategoryManagersAssignment.label.categoryManagers" />}{' '}
...
ProveedorCategoryManagersTableToolbar.propTypes = {
...
export default React.memo(ProveedorCategoryManagersTableToolbar);
